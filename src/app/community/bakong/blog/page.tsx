      ...
      <div className="w-full pb-[150px] bg-[#f8f8f6] bg-cover">
        ...
        <div className="pl-[80px] pr-[80px] pt-[30px] font-sora">
          ...
          <div className="w-full gap-[30px] pt-[60px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Link
            key={index}
            href="/community/bakong/blog/1">
              <div className="max-w-[440px] h-[432px] flex flex-col">
                <img src={`/img/community/blog${index+1}.svg`} className="max w-[440px] h-[294px]" alt="" />
                <div className="flex flex-col gap-[30px]">
                  <p className="text-[16px] font-bold text-[#300304] leading-[150%] tracking-[-0.02em] pt-[15px]">Security</p>
