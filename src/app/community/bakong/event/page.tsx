      ...
      <div className="w-full pb-[150px] bg-[#f8f8f6] bg-cover">
        ...
        <div className="px-[80px] pt-[30px] font-sora">
          ...
          <p className="font-sora text-center font-normal text-[14px] text-[#300304] leading-[150%] tracking-[-0.02em] pt-[15px]">
            Events of Bakong and see if we are heading somewhere.
          </p>
          {/* first row blog */}
          <div className="w-full gap-[30px] pt-[60px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {[1,2,3].map((item, index) => 
            <Link
            key={index}
            href="/community/bakong/event/1">
              <div className="max-w-[440px] pb-[30px] flex flex-col">
                <img src={`/img/community/blog${index+6}.svg`} className="max-w-[440px] h-[294px]" alt="" />
                <div className="flex flex-col gap-[15px]">
                  <p className="text-[16px] text-[#300304] font-bold leading-[150%] tracking-[-0.02em] pt-[15px]">Security</p>
