...
export default function FraudAndScam() {
  return (
    <section>
      <AnnouncementBar />
        ...
        <div className="pl-[80px] pr-[80px] pt-[20px] font-sora flex">
          <div className="pt-[70px] bg-red w-[50%] pt-[140px]">
            ...
            <p className="uppercase font-semibold text-[50px] leading-[120%] tracking-[-0.02em] mb-[25px]">
              Verified <br /> Merchants <br /> Only!!
            </p>
            <div className="font-normal text-[16px] leading-[150%] tracking-[-0.02em] max-w-[390px] text-justify">
              Stay informed and protected. We’re committed to helping you spot scams, avoid fraud, and pay with confidence in Cambodia’s growing digital landscape.
            </div>
      ...
      <div className="w-full pb-[780px] bg-[url('/img/card/frame.png')] bg-cover">
        <p className="uppercase font-semibold text-[38px] text-white text-center pt-[60px] leading-[120%] tracking-[-0.02em]">Real-Time Payment Alerts</p>
        {/* w-[460px] mx-auto text-justify */}
        <p className="font-normal text-[16px] text-white pt-[20px] text-center leading-[150%] tracking-[-0.02em]">Instant notifications for every transaction keep you in control—and help you <br /> catch anything suspicious fast.</p>
      </div>
      {/* third section */}
      <div className="w-full h-full pt-[60px] pb-[100px] bg-[#f8f8f6]">
        <div className="text-[#300304]">
          ...
          <p className="text-center text-[16px] font-normal leading-[150%] tracking-[-0.02em] pt-[26px]">
            We actively monitor for unusual activity and flag risky behavior before it <br /> becomes a problem.
          </p>
        </div>
        {/* first card */}
        ...
        <div className="pl-[100px] pr-[80px] pt-[230px] flex w-full">
          <div className="w-[49%] flex flex-col justify-center pt-[160px]">
            <p className="uppercase text-[32px] text-[#310405] font-semibold leading-[120%] tracking-[-0.02em]">Easy Dispute <br /> Resolution</p>
            <p className="text-[16px] text-[#310405] font-normal leading-[120%] tracking-[-0.02em] pt-[12px]">Something off? Our support team is ready to assist with fast, fair dispute <br /> handling for any suspicious payment.</p>
        ...
        <div className="pl-[100px] pr-[80px] pt-[470px]">
            <p className="uppercase text-[32px] text-[#300304] font-semibold leading-[120%] tracking-[-0.02em] text-center">Scam Awareness Education</p>
            <p className="text-center text-[16px] font-normal leading-[150%] tracking-[-0.02em] pt-[10px]">We provide in-app tips, real scam examples, and regular updates so you know <br /> what to watch for and how to stay safe.</p>
