...
export default function CardDisplay(CardDisplay: CardDisplay) {
  return (
    <div className="w-full bg-[#f8f8f6]">
      {/* first card */}
      <div className="w-full bg-[#EEECEB] min-h-screen px-[25px] md:px-12 lg:px-[80px] lg:pt-[60px] flex flex-col items-center overflow-hidden pt-[60px] md:pt-16 lg:pt-[0] md:pb-[80px]">
      ...
      <div className="w-full mt-[5px] bg-[#EEECEB] px-[25px] md:px-12 lg:px-[80px] flex flex-col lg:justify-center py-[60px] md:py-16 lg:py-0 min-h-screen overflow-hidden">
        <div className="flex flex-col md:flex-row gap-6 md:gap-0">
          <div className="w-full md:w-[50%] flex flex-col justify-center">
            <p
              className="uppercase text-[35px] lg:text-heading-1 text-[#310405] font-semibold leading-[120%] tracking-extra-small"
              dangerouslySetInnerHTML={{ __html: CardDisplay.heading2 }}
            />
            <p
              className="text-body-large text-[#310405] font-regular leading-[150%] tracking-extra-small pt-[40px] text-justify"
              dangerouslySetInnerHTML={{ __html: CardDisplay.description1 }}
            />
            <div className="flex gap-[10px] pt-[28px]">
              <div className="px-[10px] py-[15px] bg-[#3003040D]">
                <label className="font-regular text-button leading-[150%] tracking-extra-small">
                  {CardDisplay.btnText1}
                </label>
          ...
          <div className="w-full md:w-[50%] flex flex-col items-center">
            <img
              ...
              className="w-[90%] h-auto md:w-[70%] aspect-[4/4] object-cover rounded-lg mt-[70px] md:mt-0"
              alt=""
            />
          </div>
        </div>
