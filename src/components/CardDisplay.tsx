...
export default function CardDisplay(CardDisplay: CardDisplay) {
  return (
    <div className="w-full bg-[#f8f8f6] overflow-hidden">
      {/* first card */}
      <div className="w-full h-screen flex flex-col items-center justify-center overflow-hidden">
        <div className="text-[#300304]">
          <p className="text-center text-heading-1 uppercase font-semibold leading-[120%] tracking-extra-small">
        ...
        <img
          ...
          className="w-[60%] h-[59vh] object-contain mt-[43px]"
          alt="Brand view"
        />
      </div>
      {/* second card */}
      <div className="w-full h-screen px-[80px] flex flex-col justify-center overflow-hidden">
        <div className="flex">
          <div className="w-[50%] flex flex-col justify-center">
            <p className="uppercase text-heading-1 text-[#310405] font-semibold leading-[120%] tracking-extra-small"
            dangerouslySetInnerHTML={{__html:CardDisplay.heading2}}>
              
            </p>
            <p className="text-body-large text-[#310405] font-regular leading-[150%] tracking-extra-small pt-[12px]"
            dangerouslySetInnerHTML={{ __html: CardDisplay.description1 }}
            >
            </p>
          ...
          <div className="w-[50%] flex flex-col items-center">
            <img src={CardDisplay.img2} className="w-[80%] h-[60vh]" alt="" />
          </div>
        </div>
      </div>
      {/* last section */}
